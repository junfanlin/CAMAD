...
params['num_bootstrap'] = 10
params['dueling'] = True
params['seed'] = 0
params['block'] = True
params['sample_num'] = 50

params['logger_name'] = 'my_all_test_data_bgall_block3-22_push_ori_'+str(params['seed'])#'my_all_block_log'
import logging
...
patience = MuzhiEnv(data_bg='all', tol=params['max_turn'], mode='test')
patience_test = MuzhiEnv(mode='test', data_bg='test_data_bgall', tol=params['max_turn'])
