...
parser.add_argument('--num_bootstrap', default=1, type=int)
...
params['logger_name'] = 'my_train_test_data_bgall_noblock3-22_push_'+str(params['seed'])+'_'+str(params['reward'])+'_'+str(params['gamma'])+'_'+str(params['num_bootstrap'])+'_'+str(params['sample_num'])+'_bknoboot'#'my_all_block_log'
import logging
