...
params['sample_num'] = 50#args.sample_num
params['dueling'] = True
params['seed'] = args.seed
params['block'] = False

params['logger_name'] = 'my_all_test_data_bgall-22_direct_'+str(params['seed'])+'_bknoboot'#'my_all_block_log'
import logging
...
patience = MuzhiEnv(data_bg='train', tol=params['max_turn'])
